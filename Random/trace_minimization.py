...
def trace_minimization(theta, alpha, train_data, reprs, 
                       entanglement, method,
                       batch_size, eta, epochs):
    """
    This function takes the parameters of a problem and computes the optimal parameters for it, using different functions. It uses the trace minimization
    INPUT: 
...
def _session_sgd(theta, alpha, train_data, reprs, entanglement, eta, batch_size):
    ...
    return theta, alpha, Av_Tr(theta, alpha, train_data, reprs, entanglement)
...
def _scipy_minimizing(params, hypars, train_data, reprs, entanglement):
    ...
    INPUT:
        ...
        -entanglement: whether there is entanglement or not in the Ansätze, just 'y'/'n'
    OUTPUT:
        - -Av_Tr, which is the function we want to minimize
    """
    theta, alpha = _translate_from_scipy(params, hypars)
    return -Av_Tr(theta, alpha, train_data, reprs, entanglement)
...
def trace_dis(r,s):
    """
    This function returns the trace distance of two pure states
    INPUT:
        -2 vectors of pure states of the same dimension
    OUTPUT:
        -trace distance
    """
...
#==============================================================================
def _Tr(theta, alpha, data, reprs, entanglement): #Chi for one point
    """
    ...
    ans = trace_dis(reprs[y], C.r)
    return ans

#==============================================================================
#Sara
def Av_Tr(theta, alpha, train_data, reprs, entanglement): #Chi in average
    """
    This function compute chi^2 for only one point
    INPUT: 
        -theta: set of parameters needed for the circuit. Must be an array with shape (qubits, layers, 3)
    ...
    Av_Tr = 0
    for d in train_data:
        Av_Tr += _Tr(theta, alpha, d, reprs, entanglement)

    return Av_Tr / len(train_data)
#Sara
#==============================================================================
