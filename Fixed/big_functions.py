...
def minimizer(chi, problem, qubits, entanglement, layers, method, name,
        ...
        if chi == 'fidelity_chi':
            ...
            text_file_nn.write(problem +'_'+ chi +'_'+ str(layers) +'Layers_' +'train_time'+' = '+ str(tt))
            text_file_nn.write('\n')
            text_file_nn.close()
            
            acc_test = tester(theta, alpha, test_data, reprs, entanglement, chi)

            t_th=datetime.datetime.now()
            t_t=t_th-t_s
            text_file_nn = open('time.txt', mode='a+')
            text_file_nn.write(problem +'_'+ chi +'_'+ str(layers) +'Layers_' +'test_time'+' = '+ str(t_t))
            text_file_nn.write('\n')
            text_file_nn.close()
            
            text_file_nn = open('Accuracy.txt', mode='a+')
            text_file_nn.write(problem +'_'+ chi +'_'+ str(qubits) +'Qubits_' + str(layers) +'Layers_' +'acc_train'+' = '+ str(acc_train))
            text_file_nn.write('\n')
            text_file_nn.write(problem +'_'+ chi +'_'+ str(qubits) +'Qubits_' + str(layers) +'Layers_' +'acc_test'+' = '+ str(acc_test))
            text_file_nn.write('\n')
            text_file_nn.write('======================================================================')
            text_file_nn.write('\n')
            text_file_nn.close()  
            ...
            write_summary(chi, problem, qubits, entanglement, layers, method, name,
                      theta, alpha, 0, f, acc_train, acc_test, epochs=epochs)
